...
{
    public class PerformDeploy : PerformDeployOfAbstration,IPerformDeploy
    {
        ...
        public Assembly PerformFileDeploy(string plug,  NopConfig config, string shadowCopyPath = "")
        {
            ...
            if (!config.UsePluginsShadowCopy)
                return RegisterPluginDefinition(config,  plug);
            ...
            try
            {
                shadowCopiedAssembly = RegisterPluginDefinition(config,  shadowCopiedPlug);
            }
        ...
        /// <param name="plug">Plugin file info</param>
        /// <returns>Assembly</returns>
        private static Assembly RegisterPluginDefinition(NopConfig config,  string plug)
        {
